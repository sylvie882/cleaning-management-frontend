...
import { BUSINESS_INFO, buildBreadcrumbSchema, buildLocalBusinessSchema, BASE_KEYWORDS } from "../../utils/seo";
  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: "'DM Sans', sans-serif", background: "#f8fafc" }}>
      ...
      <Helmet>
        ...
        <meta name="description" content="Expert residential, commercial & post-construction cleaning in Nairobi. Deep cleaning, office cleaning, carpet & sofa cleaning across Karen, Westlands, Kilimani & all areas. Book online or call 0726 933 261." />
        <meta name="keywords" content={[...BASE_KEYWORDS, "house cleaning Karen", "office cleaning Westlands", "carpet cleaning Nairobi", "sofa cleaning Nairobi", "post construction cleaning Nairobi", "deep cleaning services Nairobi", "move in cleaning Nairobi"].join(", ")} />
        <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
        <link rel="canonical" href={PAGE_URL} />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={PAGE_URL} />
        <meta property="og:title" content="Professional Cleaning Services Nairobi | Sylvie Cleaning Services" />
        <meta property="og:description" content="Expert house cleaning, office cleaning, deep cleaning, carpet & sofa cleaning across all Nairobi areas. Book now — satisfaction guaranteed." />
        <meta property="og:image" content={`${BUSINESS_INFO.url}/services-social.jpg`} />
        ...
        <meta name="twitter:title" content="Professional Cleaning Services Nairobi | Sylvie Cleaning Services" />
        <meta name="twitter:description" content="House cleaning, office cleaning, deep cleaning across all Nairobi areas. Book online today." />
        <meta name="twitter:image" content={`${BUSINESS_INFO.url}/services-social.jpg`} />
