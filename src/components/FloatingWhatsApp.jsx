...
const FloatingWhatsApp = () => {
  ...
  const phoneNumber = "254726933261"; // Your WhatsApp number
  const message =
    "Hello Sylvie Cleaning! I got your Number on your website I'am interested in your cleaning service. "; // Default message
    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="relative">
          ...
          {/* Notification Badge (Optional - shows unread message count) */}
