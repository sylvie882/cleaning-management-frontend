        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <div className="space-y-3 mt-6">
              <div className="flex items-center space-x-4 text-gray-300 p-2 rounded-lg hover:bg-gray-800/50 transition-all">
              ...
              <div className="flex items-start space-x-4 text-gray-300 p-2 rounded-lg hover:bg-gray-800/50 transition-all">
            ...
            <div className="flex space-x-5 mt-6">
              {[
                ...
                <a
                  ...
                  className="text-gray-300 hover:text-white transition-all transform hover:-translate-y-1 bg-gray-800/50 p-3 rounded-full hover:bg-blue-500/20"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5"
          ...
          {/* Quick Links Section */}
          <div>
            <h2 className="text-lg font-bold mb-6 text-white relative pb-3 after:absolute after:left-0 after:bottom-0 after:h-0.5 after:w-12 after:bg-gradient-to-r after:from-blue-400 after:to-cyan-400">
              Quick Links
            </h2>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { to: "/services/specialized", label: "Specialized Cleaning" }
              ].map((service, index) => (
                <li key={index}>
                  <Link
                    to={service.to}
