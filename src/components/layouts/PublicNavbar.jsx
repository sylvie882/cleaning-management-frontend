...
const PublicNavbar = () => {
  ...
  return (
    <>
      {/* Enhanced Running Advertisement Banner */}
      <div className="fixed top-0 w-full z-50 bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 text-white py-3 overflow-hidden shadow-lg">
        <div className="whitespace-nowrap relative">
          <div className="inline-block animate-marquee-slow">
            <span className="mx-8 font-medium text-sm md:text-base">
              <span className="inline-flex items-center">
                <i className="fas fa-phone-alt mr-2 text-yellow-300 animate-pulse"></i>
                Call us now:
                <span className="animate-blink mx-2 font-bold text-yellow-300 text-lg">
                  0726 933 261
                </span>
              </span>
              ...
              <a
                ...
                className="inline-flex items-center mx-2 hover:text-green-300 transition-all duration-300 transform hover:scale-105 bg-green-600 hover:bg-green-700 px-3 py-1 rounded-full text-sm font-semibold shadow-md"
              >
                <svg
                ...
                WhatsApp: 0726 933 261
              </a>
              <span className="mx-4">•</span>
              <span className="inline-flex items-center">
                <i className="fas fa-star mr-2 text-yellow-300"></i>
                Premium cleaning services available round the clock
              </span>
              <span className="mx-4">•</span>
              <span className="inline-flex items-center">
                <i className="fas fa-phone-alt mr-2 text-yellow-300 animate-pulse"></i>
      ...
      <nav
        className={`fixed w-full z-40 transition-all duration-500 ease-in-out ${
          scrolled
            ? "bg-white/95 backdrop-blur-md shadow-xl py-3 mt-12"
            : "bg-white/90 backdrop-blur-sm py-5 mt-12"
        } ${
