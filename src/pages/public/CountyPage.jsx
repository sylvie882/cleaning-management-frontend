...
const CountyPage = ({ countyName }) => {
  ...
  const carouselData = [
    {
      image: cleaner1,
      title: `Professional Cleaning Services in ${countyName}`,
      subtitle: `For Your Home & Business in ${countyName} & Surrounding Areas`,
      description: `Experience the difference with our skilled cleaning professionals serving ${countyName} homes and businesses. Exceptional results every time.`,
      serviceType: "All Services",
      accent: "from-blue-500 to-cyan-500",
    },
    {
      image: cleaner2,
      title: `Residential Cleaning in ${countyName}`,
      subtitle: `Tailored to Your ${countyName} Home`,
      description: `Keep your ${countyName} living space immaculate with our detail-oriented home cleaning that goes beyond the surface.`,
      serviceType: "Residential",
      accent: "from-green-500 to-emerald-500",
    },
    {
      image: cleaner3,
      title: `Commercial Cleaning ${countyName}`,
      subtitle: "For Professional Environments",
      description: `Create a productive and healthy workspace for your ${countyName} business with our comprehensive commercial cleaning services.`,
...
// Export individual county pages
export const MombasaPage = () => <CountyPage countyName="Mombasa" />;
export const KwalePage = () => <CountyPage countyName="Kwale" />;
export const KilifiPage = () => <CountyPage countyName="Kilifi" />;
export const TanaRiverPage = () => <CountyPage countyName="Tana River" />;
export const LamuPage = () => <CountyPage countyName="Lamu" />;
export const TaitaTavetaPage = () => <CountyPage countyName="Taita-Taveta" />;
export const GarissaPage = () => <CountyPage countyName="Garissa" />;
export const WajirPage = () => <CountyPage countyName="Wajir" />;
export const ManderaPage = () => <CountyPage countyName="Mandera" />;
export const MarsabitPage = () => <CountyPage countyName="Marsabit" />;
export const IsioloPage = () => <CountyPage countyName="Isiolo" />;
export const MeruPage = () => <CountyPage countyName="Meru" />;
export const TharakaNithiPage = () => <CountyPage countyName="Tharaka-Nithi" />;
export const EmbuPage = () => <CountyPage countyName="Embu" />;
export const KituiPage = () => <CountyPage countyName="Kitui" />;
export const MachakosPage = () => <CountyPage countyName="Machakos" />;
export const MakueniPage = () => <CountyPage countyName="Makueni" />;
export const NyandaruaPage = () => <CountyPage countyName="Nyandarua" />;
export const NyeriPage = () => <CountyPage countyName="Nyeri" />;
export const KirinyagaPage = () => <CountyPage countyName="Kirinyaga" />;
export const MurangaPage = () => <CountyPage countyName="Murang'a" />;
export const KiambuPage = () => <CountyPage countyName="Kiambu" />;
export const TurkanaPage = () => <CountyPage countyName="Turkana" />;
export const WestPokotPage = () => <CountyPage countyName="West Pokot" />;
export const SamburuPage = () => <CountyPage countyName="Samburu" />;
export const TransNzoiaPage = () => <CountyPage countyName="Trans-Nzoia" />;
export const UasinGishuPage = () => <CountyPage countyName="Uasin Gishu" />;
export const ElgeyoMarakwetPage = () => <CountyPage countyName="Elgeyo-Marakwet" />;
export const NandiPage = () => <CountyPage countyName="Nandi" />;
export const BaringoPage = () => <CountyPage countyName="Baringo" />;
export const LaikipiaPage = () => <CountyPage countyName="Laikipia" />;
export const NakuruPage = () => <CountyPage countyName="Nakuru" />;
export const NarokPage = () => <CountyPage countyName="Narok" />;
export const KajiadoPage = () => <CountyPage countyName="Kajiado" />;
export const KerichoPage = () => <CountyPage countyName="Kericho" />;
export const BometPage = () => <CountyPage countyName="Bomet" />;
export const KakamegaPage = () => <CountyPage countyName="Kakamega" />;
export const VihigaPage = () => <CountyPage countyName="Vihiga" />;
export const BungomaPage = () => <CountyPage countyName="Bungoma" />;
export const BusiaPage = () => <CountyPage countyName="Busia" />;
export const SiayaPage = () => <CountyPage countyName="Siaya" />;
export const KisumuPage = () => <CountyPage countyName="Kisumu" />;
export const HomaBayPage = () => <CountyPage countyName="Homa Bay" />;
export const MigoriPage = () => <CountyPage countyName="Migori" />;
export const KisiiPage = () => <CountyPage countyName="Kisii" />;
export const NyamiraPage = () => <CountyPage countyName="Nyamira" />;
export const NairobiPage = () => <CountyPage countyName="Nairobi" />;
